                ...
                \_ ->
                    let
                        ...
                        expectedResult =
                            ...
                            , MapTile M1a 4 6 True True
                            , MapTile M1a 5 6 False True
                            , MapTile A1a -1 5 False True
                            , MapTile A1a 0 6 False True
                            , MapTile A1a 0 7 False True
                            , MapTile A1a 1 8 False True
                            , MapTile A1a 1 9 False True
                            , MapTile A1a -1 6 True True
                            , MapTile A1a -1 7 True True
                            , MapTile A1a 0 8 True True
                            , MapTile A1a 0 9 True True
                            , MapTile A1a 1 10 False True
                            , MapTile A1a -2 6 True True
                            , MapTile A1a -2 7 True True
                            , MapTile A1a -1 8 True True
                            , MapTile A1a -1 9 True True
                            , MapTile A1a 0 10 True True
                            , MapTile A1a -3 7 False True
                            , MapTile A1a -2 8 False True
                            , MapTile A1a -2 9 False True
                            , MapTile A1a -1 10 False True
                            , MapTile A1a -1 11 False True
                            ]
                    in
                    Scenario.mapTileDataToList tileData
                        |> Expect.equalLists expectedResult
